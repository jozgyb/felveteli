...
?>
        <pre><?php
                ...
                Megkeresni az ID-t:
                [id] => 1470
                https://gorest.co.in/public/v1/users/1470
                A most felvitt erőforrás kiíratása:
                </pre><?php
 $url = "https://gorest.co.in/public/v1/posts/1470?access-token=b0510476761951d379e4f092784758d5ea6b432000616b7f2a2cfe5c23822e4c";
...
print_r(json_decode($tabla, JSON_PRETTY_PRINT));
        ...
        <pre><?php
                ...
                if (isset($_POST['gombtorles'])) {
                        ...
                        echo "<pre>";
                        print_r(json_decode($tabla, JSON_PRETTY_PRINT));
                        print_r("A tanár úr ezt a sort törölte! ID: 1470");
                        echo "</pre>";
                }
                        ?>